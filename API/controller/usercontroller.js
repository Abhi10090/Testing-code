...
//Save is a type of method or opration for save detail in mongodb with schema(mongodb-model).
...
//login is a type of method or opration used for user login . and genrate token (combination of keys and string ,it is unique help to track user and done spacial oprations through token).
...
//Fetch is a type of method or opration for find user detail in mongodb with schema(mongodb-model).
...
//updateuser is a type of method or opration for update user detail in mongodb with schema(mongodb-model).
...
//Deleteuser is a type of method or opration for delete user detail in mongodb with schema(mongodb-model).
